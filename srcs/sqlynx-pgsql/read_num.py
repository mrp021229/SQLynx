...
def read_integer_from_file(filename="/home/SQLynx/srcs/sqlynx-pgsql/num.txt"):
    try:
...
def write_integer_to_file(integer, filename="/home/SQLynx/srcs/sqlynx-pgsql/num.txt"):
    try:
